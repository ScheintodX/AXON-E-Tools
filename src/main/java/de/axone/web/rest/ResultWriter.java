...
public class ResultWriter {
	...
	public static void writeValue( JsonMapper.Builder jmb, PrintWriter out, Object data )
			throws JsonGenerationException, JsonMappingException, IOException{

		writeValue( jmb, out, data, null, (ValidatorResult)null, null );
	}

	public static void writeValue( JsonMapper.Builder mapper, PrintWriter out, Object data, Map<String,Object> overwrite )
			throws JsonGenerationException, JsonMappingException, IOException{

		writeValue( mapper, out, data, null, (ValidatorResult)null, overwrite );
	}

	public static void writeValue( JsonMapper.Builder mapper, PrintWriter out,
	...
	public static void writeValue( JsonMapper.Builder jmb, PrintWriter out,
			Object data, List<?> errors, Map<String,Object> overwrite )
			throws JsonGenerationException, JsonMappingException, IOException{

		JsonMapper mapper = jmb.build();
